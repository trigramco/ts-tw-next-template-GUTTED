...
<div align="center" mb="16px">
  ...
  <p align="left">I have gotten a huge amount of mileage from the original template, and have started and completed many projects using it. However, if I'm creating a prototype or a very small project, it's tedious to remove all of the excessive junk that would normally be useful for non-small projects, such as jest, the colors.css file, most of the components, the example pages, and other small things.</p>
